...
// ============================================================
// Dependency-free WebView file upload: the partner site's
// <input type="file"> triggers the WebView file selector, which hops
// here over a MethodChannel and returns the picked content:// URIs
// back to the WebView.
//
// The channel name must EXACTLY match the value used in
// lib/gray_scenes/pitch_web_scene.dart → MethodChannel(...).
// ============================================================
class MainActivity : FlutterActivity() {
    private val channelName = "goalrush.pitch/upload"
    private val pickRequest = 0x5A02
